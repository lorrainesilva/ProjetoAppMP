...
DFLAGS = -ggdb -O0
TESTFLAGS = -DTEST #-ftest-coverage -fprofile-arcs
...
clean:
	...
	$(RM) $(EXEC) $(wildcard *.gcda) $(wildcard *.gcno)
...
help:
	...
	@echo - test:     Builds a version to use gtest
	@echo - clean:    Clean build's files (including the executable) and directories
